        ...
        <div className={classNames(styles.root, className)}>
            <div className={styles.hero}>
                ...
                <div className={styles.paragraph}>
                    Your sustainable matching platform connects African tech-Startups with global
                    investors to create an impact for the world and unlock profits
                </div>
            ...
            <div className={styles['cards-container']}>
                <div className={styles.cards}>
                    ...
                    <p className={styles.paragraph}>
                        Securing funding is a major hurdle for many startups. The journey is filled
                        with potential but finding the right investor often feels like searching in
                        the dark. This is where EarthMates steps in. We simplify the search for
                        funding.
                    </p>
                    <p className={styles.paragraph}>
                        Our platform brings together startups and investors, ensuring you connect
                        with those who share your vision and goals. If you&apos;re looking for
                        funding that aligns with your startup&apos;s potential, EarthMates is here
                        to help. Ready to meet your EarthMate?
                    </p>
                </div>
                <div className={styles.cards}>
                    <div className={styles.header}>
            ...
            <div className={styles.features}>
                <div className={styles['features-startup']}>
                    ...
                    <p className={styles.p}>
                        ...
                        diverse network of investors and access the funding they need to scale their
                        ventures. Whether you&apos;re seeking seed funding to launch your idea or
                        looking to secure Series A funding for expansion, Earthmates can help you
                        find the right investors to support your growth journey.
                    </p>
                ...
                <div className={styles['features-investor']}>
                    ...
                    <p className={styles.p}>
                        ...
                        high-potential African startups poised for growth. Whether you&apos;re an
                        angel investor, venture capitalist, or corporate investor, Earthmates
                        provides access to a curated selection of investment opportunities across
            ...
            <div className={styles.home}>
                <div className={styles.mission}>
                    ...
                    <p className={styles.p}>
                        We create connections between African leading tech startups and global
                        investors, dedicated to catalyzing social impact and innovation across
                        Africa.
                    </p>
                ...
                <div className={styles.vision}>
                    <div className={styles['vision-text']}>
                        ...
                        <p className={styles.p}>
                            Our vision is to create an ecosystem where African startups can not only
                            survive, but thrive and flourish by positively impacting local and
                            global communities through sustainable innovation.
                            <br />
                            <br />
                            We dream of a future where African innovation is at the forefront of
                            solutions to the climate crisis and social injustices, supported by a
                            global network of partners working together to create a fairer, more
                            sustainable world
                        </p>
                    ...
                    <div className={styles['value-cards']}>
                        ...
                        <div className={styles.card}>
                            ...
                            <p className={styles.p}>
                                ...
                                creativity and innovation to develop sustainable solutions to global
                                challenges.
                            </p>
                        </div>
                        <div className={styles.card}>
                            ...
                            <p className={styles.p}>
                                Our commitment to the planet is evident in our support for startups
                                dedicated to tackling the climate crisis through sustainable
                                innovation.
                            </p>
                        </div>
                        <div className={styles.card}>
                ...
                <div className={styles.team}>
                    ...
                    <p className={styles.p}>
                        Get to know the passionate individuals behind Earthmates who are dedicated
                        to supporting <br />
